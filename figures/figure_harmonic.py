...
fig.axes[0].set_xlim([0.8 / t_hop, 5.2 / t_hop])
fig.axes[0].set_ylim([0. * t_fft, 4000. * t_fft])
plt.tight_layout()

plt.savefig('figure_harmonic.eps', bbox_inches='tight', pad_inches=0, transparent=True)
